...
public class SubjectFourAdapter extends ArrayAdapter<ModelCommon> {
    public SubjectFourAdapter(@NonNull Context context, int resource, @NonNull List<ModelCommon> objects) {
