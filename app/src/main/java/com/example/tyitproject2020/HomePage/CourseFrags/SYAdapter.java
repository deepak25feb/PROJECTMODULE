...
public class SYAdapter extends ArrayAdapter<SYModel> {
    public SYAdapter(@NonNull Context context, int resource, @NonNull List<SYModel> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        SYModel model = getItem(position);
