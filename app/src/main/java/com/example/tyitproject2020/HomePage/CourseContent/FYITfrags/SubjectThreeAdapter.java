...
public class SubjectThreeAdapter extends ArrayAdapter<ModelCommon> {
    public SubjectThreeAdapter(@NonNull Context context, int resource, @NonNull List<ModelCommon> objects) {
