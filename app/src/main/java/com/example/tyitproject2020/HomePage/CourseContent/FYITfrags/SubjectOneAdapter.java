...
public class SubjectOneAdapter extends ArrayAdapter<ModelCommon> {
    public SubjectOneAdapter(@NonNull Context context, int resource, @NonNull List<ModelCommon> objects) {
