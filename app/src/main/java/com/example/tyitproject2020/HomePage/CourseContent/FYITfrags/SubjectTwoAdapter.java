...
public class SubjectTwoAdapter extends ArrayAdapter<ModelCommon> {
    public SubjectTwoAdapter(@NonNull Context context, int resource, @NonNull List<ModelCommon> objects) {
