...
public class FYAdapter extends ArrayAdapter<FYModel> {
    public FYAdapter(@NonNull Context context, int resource, @NonNull List<FYModel> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        FYModel model = getItem(position);
